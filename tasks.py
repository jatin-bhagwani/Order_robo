...
# def fill_form(order_rep):
#     def select_body():
#         """body"""
#         if order_rep['Body'] == '1':
#             return '#id-body-1'
#         elif order_rep['Body'] == '2':
#             return '#id-body-2'
#         elif order_rep['Body'] == '3':
#             return '#id-body-3'
#         elif order_rep['Body'] == '4':
#             return '#id-body-4'
#         elif order_rep['Body'] == '5':
#             return '#id-body-5'
#         elif order_rep['Body'] == '6':
#             return '#id-body-6'
        
#     page = browser.page()

#     page.select_option('#head', order_rep["Head"])

#     page.click(select_body())
    
  
#     page.fill("//input[@placeholder='Enter the part number for the legs']",order_rep["Legs"])
